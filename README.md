...
This file removes all the audio portions of the code in case you only want to use the servo to spin the barrel. It also doesn't have a delay in spinning, just spins when the trigger is pressed.
